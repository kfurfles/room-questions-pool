...
type LikeIconProps = Partial<React.SVGProps<SVGSVGElement> & { active?: boolean }>

export const LikeIcon: React.FC<LikeIconProps> = (props) => {
  ...
  return(
    <>
      { active
        ...
        : <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd" {...rest}>
